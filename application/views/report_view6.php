...
<div data-role="content">
      <div class="container">  
     <center> <p>เลือกรูปภาพอาการแพ้ของผู้ป่วย</p></center>
        <form>
           ...
           <center>   <p>ภาพถ่ายประกอบที่1</p></center>
           <div class="form-group">
              <label for="day"></label>
              <center><form action="upload-script-url" method="post" enctype="multipart/form-data"></center>
              <input type="file" name="file">
        ...
        <center>   <p>ภาพถ่ายประกอบที่2</p></center>
           <div class="form-group">
              <label for="day"></label>
              <form action="upload-script-url" method="post" enctype="multipart/form-data">
              <input type="file" name="file">
        ...
        <center>   <p>ภาพถ่ายประกอบที่3</p></center>
           <div class="form-group">
              <label for="day"></label>
              <form action="upload-script-url" method="post" enctype="multipart/form-data">
              <input type="file" name="file">
